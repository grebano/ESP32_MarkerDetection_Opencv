...
img = cv2.imread('test0.jpg', 0) #read image as grayscale
...
while(1):
  ...
  if k == 27: #escape key
      break
  l = cv2.getTrackbarPos('L', 'image') #get the value of lower threshold trackbar
  u = cv2.getTrackbarPos('U', 'image') #get the value of upper threshold trackbar
